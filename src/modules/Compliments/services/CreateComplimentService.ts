import { ICreateCompliment, IUsersRepository, IComplimentsRepository } from '../../../@types';
import Compliment from '../../../database/entities/Compliment';
import ExceptionError from '../../../errors/ExceptionError';

class CreateComplimentService {
  constructor(private complimentsRepository: IComplimentsRepository, private usersRepository: IUsersRepository) {}
